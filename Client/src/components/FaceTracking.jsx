...
const FaceTracking = ({name}) => {
  return (
    <aside className='my-28 flex flex-col items-center justify-center'>
        ...
        <div className='w-full flex'>
            <div className='w-1/3 p-10 bg-[#8381FD] flex flex-col items-center justify-center'>
                <button className='p-4 bg-[#4A51ED] text-white text-2xl rounded-xl my-8'>Upload File</button>
                <button className={`${name === "VIDEO" ? "hidden" : ""} p-4 bg-[#4A51ED] text-white text-2xl rounded-xl my-8`}>Download</button>
            </div>
