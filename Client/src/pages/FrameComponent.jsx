...
const FrameComponent = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1080px] overflow-hidden text-left text-5xl text-white font-inter">
      ...
      <div className="absolute top-[0px] left-[0px] bg-gray-200 w-[1920px] h-28 flex flex-row items-center justify-center gap-[107px]">
        <button
      ...
      <div className="absolute top-[168px] left-[29px] w-[838px] h-[775.35px] text-9xl text-black">
        <div className="absolute top-[361px] left-[1px] w-[837px] h-[414.35px]">
