...
const FrameComponent1 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1080px] overflow-hidden text-left text-9xl text-black font-inter">
      ...
      <div className="absolute top-[168px] left-[30px] w-[837px] h-[773.49px]">
        <img
          className="absolute top-[0px] left-[0px] w-[792px] h-[191px]"
          alt=""
          src="/vector1.svg"
        />
        <div className="absolute top-[361px] left-[0px] w-[837px] h-[412.49px]">
          ...
          <div className="absolute top-[355.45px] left-[703px] rounded bg-gainsboro-200 box-border w-[79px] h-[49.38px] border-[2px] border-solid border-dodgerblue" />
          <div className="absolute top-[356.12px] left-[656px] text-17xl leading-[128.02%] text-dodgerblue">
            -
          </div>
          <div className="absolute top-[356.12px] left-[734px] text-17xl leading-[128.02%] text-dodgerblue">
            +
          </div>
          ...
          <div className="absolute top-[375px] left-[108px] w-[160.25px] h-[33.37px] text-5xl">
