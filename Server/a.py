...
cursor.execute("CREATE TABLE IF NOT EXISTS face_encodings2 (id INT AUTO_INCREMENT PRIMARY KEY, encoding TEXT, timestamp DATETIME)")
...
#known_image = face_recognition.load_image_file("shubham1.png")
